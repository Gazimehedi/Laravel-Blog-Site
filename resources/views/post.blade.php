                ...
                <div class="col-md-12 col-lg-10">
                    <div class="post-entry text-center">
                        ...
                        <div class="post-meta align-items-center text-center">
                            <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{ asset($post->user->image) }}"
        ...
        <div class="container">
            <div class="row blog-entries element-animate">
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="pt-5">
                        <p>Categories: <a href="{{ route('category', $post->category->slug) }}">{{ $post->category->name }}</a>
                            &nbsp;&nbsp;
                            @if ($post->tag->count() > 0)
                                Tags:
                                    ...
                                    <li>
                                        <a href="{{ url('post/' . $post->slug) }}">
                                            ...
                                            <div class="text">
                                                <h4>{{ $post->title }}</h4>
                                                <div class="post-meta">
                                                    <span class="mr-2">{{ $post->created_at->format('M d, Y') }}
                                                    </span>
                                                </div>
                                            </div>
                                        </a>
        ...
        <div class="container">
            ...
            <div class="row align-items-stretch retro-layout">
                ...
                <div class="col-md-7">
                    ...
                    @endforeach
                    <div class="two-col d-flex justify-content-between d-md-flex">
                        @foreach ($relatedMiddle2 as $post)
