...
@section('content')
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{ asset('assets') }}/images/img_4.jpg');">
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 mb-5">
            ...
            @endif
          <form action="{{route('message.send')}}" method="post" class="p-5 bg-white">
            @csrf
        ...
        <div class="col-md-5">
          ...
          <div class="p-4 mb-3 bg-white">
            ...
            <p class="mb-4"><a href="#">{{ $setting->mobile }}</a></p>
