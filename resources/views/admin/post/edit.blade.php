                ...
                <form action="{{route('admin.post.update',$post->id)}}" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{$post->title}}" placeholder="Enter post title" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <div class="row">
                              ...
                              <div class="col-md-3">
                                  <img src="{{asset($post->image)}}" height="100px" width="150px" class="image-fluid">
                              </div>
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea rows="4" class="form-control" name="description" id="description" placeholder="Enter post description" required>{!!$post->description!!}</textarea>
                      </div>
                    </div>
                    <!-- /.card-body -->
